package com.teamanime.Propra.Constraint;
...
public class PasswordFieldsValueMatchValidator implements ConstraintValidator<PasswordValueMatch, Object>  {
    ...
    public boolean isValid(Object value,
        ...
        if (fieldValue != null  && fieldMatchValue!=null) {
            ...
            System.err.println("now" +isValid);
            System.err.println("fields:  "+(String)fieldValue+ "---"+(String)fieldMatchValue);
        }

        if (!isValid) {
        	 System.err.println("after" +isValid);
